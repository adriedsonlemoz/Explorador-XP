...
object FileTypeClassifier {
    private val labels = mapOf(
        ...
        "js" to "Código JavaScript", "json" to "Arquivo JSON", "xml" to "Arquivo XML", "yaml" to "Arquivo YAML",
        "yml" to "Arquivo YAML", "php" to "Código PHP", "py" to "Código Python", "java" to "Código Java",
        "kt" to "Código Kotlin", "c" to "Código C", "h" to "Cabeçalho C/C++", "cpp" to "Código C++",
