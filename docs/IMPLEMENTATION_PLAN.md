...
- Alpha.28: experimento vetorial da alpha.27 revertido após teste real sem ganho perceptível; mantido o pipeline PNG assíncrono/cacheado da alpha.23/26. Próximo: medir jank/FrameTimingMetric antes de novas mudanças visuais.
